...
class JWTTokenAuthenticator extends AbstractGuardAuthenticator
{
    ...
    public function start(Request $request, AuthenticationException $authException = null)
    {
        ...
        $event     = new JWTNotFoundEvent($exception, new JWTAuthenticationFailureResponse('please add the authorization header'));
    ...
    protected function loadUser(UserProviderInterface $userProvider, array $payload, $identity)
    {
        ...
        return $userProvider->loadUserByUsername($payload);
